package com.chason.book.book.result;
...
public class Result<T> {
    ...
    /**
     * 正确返回：status=0，msg=null，data 数据
     * @param o
     * @return
     */
    ...
    /**
     * 正确返回：status=0，msg，data=null 数据
     * @param str
     * @return
     */
    ...
    /**
     * 正确返回：status=0，msg=提示信息，data 数据
     * @param o
     * @param  msg
     * @return
     */
    ...
    /**
     * 异常返回：status=-1，msg= 异常信息，data 数据为null
     * @param error
     * @return
     */
